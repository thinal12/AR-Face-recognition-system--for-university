    ...
    return (
      <>
        ...
        <Text style={styles.description}>
          ...
          the lecture hall. Once the student is recognized you can then click on
          the 'Record Names' button which will then record the names of the
        ...
        <Text style={styles.description}>
          2. When a person recognized a box will appear around their face along
          with a button that called 'View Profile'. Click the button view the
        ...
        <Text style={styles.description}>
          *Note: Only one student profile can be viewed at a time. If you want
          to view another student's profile, you must first press the back space
          which will take you back to the home page and start the process again.
        </Text>
        <Text style={styles.section}>
        ...
        <Text style={styles.description}>
          ...
          to the specific lecture you want to record attendance for. you can do
          this by selecting the module that the lecture belongs to from the home
          page.
        </Text>
        <Text style={styles.description}>
        ...
        <Text style={styles.description}>
          1. Utilize the search functionality to find specific student profiles.
          You must first click the student search button on the bottom
          navigation bar.
        </Text>
        <Text style={styles.description}>
          2.Enter the student's name or ID in the search bar and click the card.
        </Text>
        <Text style={styles.description}>
